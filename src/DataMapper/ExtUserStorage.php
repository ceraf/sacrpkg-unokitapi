...
use sacrpkg\UnokitapiBundle\DataMapper\StorageAdapterInterface;

class ExtUserStorage implements StorageAdapterInterface
{
    private $api;
    private $address;
    ...
    public function findById(int $id)
    {
        ...
        $this->api->setMethod(Api::METHOD_GET)
            ...
            ->setHeader([
                ...
                'Authorization: Bearer '.$_ENV['EXTAUTH_TOKEN']
            ])
            ->setParams([])
            ->process($procset); 
